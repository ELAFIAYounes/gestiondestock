...
public class add_produit_activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        Product product = new Product(name,Double.valueOf(price), Integer.valueOf(qte));
